...
In the terminal, make sure that you are in the same directory (location) as the jar file is, and o+xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx run java -
jar JAR_FILE_NAME where
