...
public class Commands {
	...
	private void addCurrentCommands(){
		...
		commandsAndDescription.put("prereq", "Displays the prerequisites for a specific module based on your course.");
		commandsAndDescription.put("test", "Displays requirements for a specific major.");
		commandsAndDescription.put("recommend", "Generates and displays a recommended schedule based on a keyword.");
