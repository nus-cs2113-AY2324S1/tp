...
public class Ui {
    ...
    public static void printFinancialStatement(String[] texts) {
        ...
        final int TOTAL_SPACE = ID_SPACE + TYPE_SPACE + DATE_SPACE + DESCRIPTION_SPACE + AMOUNT_SPACE + 6;

        // Header
        printHeader(ID_SPACE, TYPE_SPACE, DATE_SPACE, DESCRIPTION_SPACE, AMOUNT_SPACE);
        ...
        for (int i = 0; i < texts.length; i++) {
            ...
            printTableRow(i + 1, type, date, description, amount, sign, ID_SPACE, TYPE_SPACE, DATE_SPACE, DESCRIPTION_SPACE, AMOUNT_SPACE);
        }
    ...
    private static void printHeader(int idSpace, int typeSpace, int dateSpace, int descriptionSpace, int amountSpace) {
        System.out.println("+" + repeatChars('-', idSpace) + "+" + repeatChars('-', typeSpace) + "+" + repeatChars('-', dateSpace) + "+" + repeatChars('-', descriptionSpace) + "+" + repeatChars('-', amountSpace) + "+");
        System.out.println("|" + centerText("ID", idSpace) + "|" + centerText("Type", typeSpace) + "|" + centerText("Date", dateSpace) + "|" + centerText("Description", descriptionSpace) + "|" + centerText("Amount", amountSpace) + "|");
        System.out.println("+" + repeatChars('-', idSpace) + "+" + repeatChars('-', typeSpace) + "+" + repeatChars('-', dateSpace) + "+" + repeatChars('-', descriptionSpace) + "+" + repeatChars('-', amountSpace) + "+");
    }

    private static void printTableRow(int id, String type, String date, String description, double amount
        , String sign, int idSpace, int typeSpace, int dateSpace, int descriptionSpace, int amountSpace) {
        System.out.println("|" + centerText(String.valueOf(id), idSpace) + "|" + centerText(type, typeSpace)
            ...
            + "|" + centerText(sign + " $" + amount, amountSpace) + "|");
    }
