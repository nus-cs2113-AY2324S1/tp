...
public class IndexOutOfBoundsException extends IllegalValueException {
    public static IndexOutOfBoundsException LIST_EMPTY = new IndexOutOfBoundsException(
            "Index out of range. List is empty!"
    );
    public static IndexOutOfBoundsException INDEX_INVALID = new IndexOutOfBoundsException(
